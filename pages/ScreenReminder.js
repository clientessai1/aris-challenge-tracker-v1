...
import { fetchDataFromDbUnfinished, updateChallenges, updateEffectueInChallenges } from './Db/DbManager2';
...
const ScreenReminder = ({navigation}) => {
...
const getBtnStyle = (item) => {
  ...
  return (
    ...
    <View style={my_styles.container_2}>        
        <Text style={my_styles.title}>RAPPEL</Text>        
    </View>
